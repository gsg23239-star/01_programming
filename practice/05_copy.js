...
var originalUser = {
    name: "김철수fsadjflksadfjasldk;fjasf;lkasdjfsla;kfjasfl;ksajflaskfjas;lkfjasf;lkasdfjlaks",
    age: 25,
    sex: "Male",
};
...
// 스프레드 문법만 써서 사용하면 아래와 같은 결과가 됨 => 즉, 프로퍼티가 객체면 걔도 마찬가지로 주소값만 복사됨
// var dUser2 = {
//     name: oUser2.name,
//     age: oUser2.age,
...
//     name: oUser2.name,
//     age: oUser2.age,
//     address: oUser2.address,        // 객체 안에 동일한 key를 갖고 있는 프로퍼티가 있다면, 덮어쓰기됨
//     address: {
//         ...oUser2.address,
//     }
// };